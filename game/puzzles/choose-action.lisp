...
move direction to approach a resource."
  (make-puzzle
   :id :choose-action
   :title "choose-action"
   :description "Write (choose-action my-pos resource-pos) that returns a
direction symbol ('up, 'down, 'left, 'right) to move closer to the resource.
If already at the resource, return 'pickup. Prefer vertical movement when
distances are equal."
   :signature "(choose-action my-pos resource-pos)"
   :hint "Compare row and col differences. Move in the axis with larger gap, preferring vertical. Return quoted symbols like 'down."
   :difficulty 3
   :test-cases
   (list
